...
<c:url var="getPOListBetDateAndPlantId"
	value="/getPOListBetDateAndPlantId" />
<%-- 
...
<body>
							...
							<div class="card-body card-block">
								...
								<div class="card-body card-block">
									<table id="bootstrap-data-table"
										...
										<tbody>
											<c:forEach items="${getPoList}" var="poList"
												varStatus="count">
												<tr>
													<td><input type="checkbox" class="chk" name="poIds"
														id="poIds${count.index+1}" value="${poList.poId}" /></td>
	...
	<script type="text/javascript">
		...
		function callEdit(poId) {
			...
			window.open("${pageContext.request.contextPath}/editPo/" + poId);
