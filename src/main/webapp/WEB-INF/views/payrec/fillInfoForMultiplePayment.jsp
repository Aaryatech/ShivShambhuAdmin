...
<body>
					...
					<div class="card">
						...
						<div class="card-body card-block">
							...
							<form name="submitForm"
								action="${pageContext.request.contextPath}/submitInfoForMultiplePayment"
								id="submitForm" method="post">
								<c:set var="totalPending" value="0"></c:set>
								<c:forEach items="${payheaderList}" var="payheaderList">
									<div class="row">

										<div class="col-md-1">Bill No.</div>
										<div class="col-md-2">
											<input type="text" id="billTotal" name="billTotal"
												autocomplete="off" value="${payheaderList.billNo}" readonly
										...
										<div class="col-md-2">
											<input type="text" id="paidAmt1" name="paidAmt1"
												autocomplete="off" value="${payheaderList.paidAmt}"
										...
										<div class="col-md-2">
											<input type="text" id="pendingAmt" name="pendingAmt"
												...
												autocomplete="off" value="${payheaderList.pendingAmt}"
												readonly class="form-control" required style="width: 100%;">
											<c:set var="totalPending"
												value="${totalPending+payheaderList.pendingAmt}"></c:set>
										</div>
									</div>
									<br>
								</c:forEach>
								<div class="row">
									...
									<div class="col-md-2">${selectedAmt}<input type="hidden"
											id="selectedAmt" name="selectedAmt" class="form-control"
											value="${selectedAmt}" readonly style="text-align: right;">
									</div>
								</div>
								<br>
								<hr>
								...
								<div class="col-lg-2">
									...
									<input type="button" onclick="formSumbit()"
	...
	function formSumbit() {
		...
		if (!$("#paidAmt").val()) {
			...
			var selectedAmt = parseFloat($("#selectedAmt").val());
			var paidAmt = parseFloat($("#paidAmt").val());
			
			if (paidAmt>selectedAmt) {
				alert("Insert less Ammount");
		...
		if(isError==true){
			 ...
			 form.setAttribute("method", "post"); 
				form.action = ("${pageContext.request.contextPath}/submitInfoForMultiplePayment/"); 
				form.submit();  
		 }
