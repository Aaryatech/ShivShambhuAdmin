	...
	function showChalnItems(){
		...
		var chalanQty = '<input  type="text" value="'+v.chalanQty+'" readonly class="form-control"  id="chalanQty'+v.itemId+'" name="chalanQty'+v.itemId+'"  onkeypress="return allowOnlyNumber(event);"/>'
														...
														dataTable.row
																.add(
																		[
																			index,v.itemName,v.uomName,v.poQty,v.poRemainingQty,v.orderQty,v.remOrdQty,chalanQty,width,height,length,itemChalanTotal]).node()
																			 $(dataTable).attr("id","tr"+v.itemId);
													});
