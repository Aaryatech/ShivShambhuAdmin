				...
				<div class="col-xs-12 col-sm-12">
					<div class="card">
						...
						<div class="card-body card-block">
							<form action="${pageContext.request.contextPath}/insertManualBOM"
								method="post">
...
<!-- 												<th style="text-align: center">Unit of Measurement</th>
 ...
 --%>
										...
										<input  type="text"  class="form-control" value="0"  id="rmQty${itemDetail.itemDetailId}" name="rmQty${itemDetail.itemDetailId}" />
										</td>
