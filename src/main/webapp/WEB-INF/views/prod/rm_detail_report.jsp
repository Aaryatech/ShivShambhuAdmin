									...
									<table id="bootstrap-data-table"
										...
										<thead>
											<tr>
												...
												<th style="text-align: center">BOM Request Date</th>
										...
										<tbody>
									<c:forEach items="${rmDetailReportList}" var="rmDReport" varStatus="count">
										<tr>
											...
											<td style="text-align: left"><c:out
													...
													value="${rmDReport.bomReqDate}" /></td>
											<td style="text-align: right"><c:out
													value="${rmDReport.rmReqQty}" /></td>
													
														<c:if test="${rmDReport.status==1}">
									<c:set var="status" value="Requested"></c:set>
								</c:if>
								
								<c:if test="${rmDReport.status==2}">
									<c:set var="status" value="Approved"></c:set>
								</c:if>
								
								<c:if test="${rmDReport.status==3}">
									<c:set var="status" value="Rejected"></c:set>
								</c:if>
