...
<c:url var="getPendingBillBetDate" value="/getPendingBillBetDate" />
 ...
 -->
			...
			if (valid == true) {
				...
				function(data) {
					...
					$.each(data, function(i, v) {
						...
						dataTable.row.add(
								[ i + 1, v.orderDate, v.orderNo, v.chalanDate,
										v.chalanNo, v.custName, v.custMobNo,
										v.itemName, v.itemQty
	...
	<script type="text/javascript">
		function genPdf() {
			...
			window
					.open('${pageContext.request.contextPath}/showBillPendingPdf/'
							+ fromDate + '/' + toDate);
			document.getElementById("expExcel").disabled = true;
