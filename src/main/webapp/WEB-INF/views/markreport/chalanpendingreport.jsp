...
<c:url var="getPendingChalanBetDate" value="/getPendingChalanBetDate" />
 ...
 -->
	...
	<script type="text/javascript">
		...
		function showQuot() {
			...
			if (valid == true) {
				...
				$.getJSON('${getPendingChalanBetDate}', {
					custId : custId,
					fromDate : fromDate,
					toDate : toDate,
					ajax : 'true',
				...
				function(data) {
					...
					$.each(data, function(i, v) {
						...
						dataTable.row.add(
								[ i + 1, v.orderDate, v.orderNo, v.custName,
										v.custMobNo, v.itemName, v.orderQty
	...
	<script type="text/javascript">
		function genPdf() {
			...
			window
					.open('${pageContext.request.contextPath}/showChalanPendingPdf/'
							+ fromDate + '/' + toDate);
			document.getElementById("expExcel").disabled = true;
