...
public class ChalanDetail {
	...
	public String toString() {
		return "ChalanDetail [chalanDetailId=" + chalanDetailId + ", chalanId=" + chalanId + ", itemId=" + itemId
				+ ", itemUom=" + itemUom + ", itemQty=" + itemQty + ", itemQtyBeforeEdit=" + itemQtyBeforeEdit
				+ ", itemLengthPlant=" + itemLengthPlant + ", itemWidthPlant=" + itemWidthPlant + ", itemHeightPlant="
				+ itemHeightPlant + ", itemTotalPlant=" + itemTotalPlant + ", itemLengthSite=" + itemLengthSite
